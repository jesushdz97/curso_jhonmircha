...
const TeoriaRedux = ({ showTeoria, setShowTeoria }) => {
  return (
    <div className='mt-5'>
      <button
        className='border-collapse p-2 rounded shadow bg-slate-700 text-white hover:bg-red-400 mb-7'
        onClick={() => setShowTeoria(!showTeoria)}>
        Mostrar Teoria
      </button>
      {showTeoria && (
        <div>
          ...
          <img src={reduxImg} alt='Diagrama Redux' className='mx-auto w-100' />
          <img
            src={reduxGif}
